...
class ReviewController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            // Make sure feedback isn't null before saving to database
            ...
            return redirect()->back()->with('error', 'An error occurred while processing your review. Please try again later.');
        }
    }
} 