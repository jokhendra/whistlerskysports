...
@section('content')
  <div class="container mx-auto px-4 py-8 sm:py-12 mt-24">
    <div class="max-w-7xl mx-auto">
        <h1 class="weather-title text-3xl sm:text-4xl md:text-6xl font-bold text-center mb-4 text-blue-900 bg-clip-text bg-gradient-to-r from-blue-900 to-blue-600">Interactive Weather Map</h1>
        ...
        <!-- Interactive Windy Map - Full Width -->
        <div class="bg-gradient-to-br from-white to-blue-50 rounded-2xl sm:p-8 border border-blue-100 windy-container">
            <!-- Main Windy Iframe - Full Width -->
            <div class="w-full overflow-hidden rounded-xl border-2 border-blue-200 bg-white">
                <iframe 
                    width="100%" 
                    height="650" 
        ...
        <!-- Weather Info Section - Now Below Map -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <!-- Controls Section -->
            <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-4 sm:p-6 border border-blue-100 weather-card">
                <h2 class="section-title text-xl font-bold text-blue-900 mb-4 flex items-center">
            ...
            <div class="bg-gradient-to-br from-red-50 to-white rounded-xl p-4 sm:p-6 border border-red-100 weather-card">
                <h2 class="section-title text-xl font-bold text-red-900 mb-4 flex items-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 border border-blue-100 weather-card">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="feature-title text-lg font-bold text-blue-900">Wind Patterns</h3>
                </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 border border-blue-100 weather-card">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="feature-title text-lg font-bold text-blue-900">Precipitation</h3>
                </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 border border-blue-100 weather-card">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="feature-title text-lg font-bold text-blue-900">Temperature</h3>
                </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 border border-blue-100 weather-card">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="feature-title text-lg font-bold text-blue-900">Cloud Coverage</h3>
                </div>
        ...
        <div class="bg-gradient-to-br from-white to-blue-50 rounded-2xl p-6 mt-12 border border-blue-100">
            <h2 class="section-title text-2xl font-bold text-blue-900 mb-4 flex items-center">
