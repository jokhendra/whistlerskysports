@extends('layouts.app')
@section('content')
<div class="min-h-screen bg-gradient-to-b from-gray-100 to-white py-12">
            ...
            <div class="bg-blue-50 rounded-2xl p-8">
                <form action="{{ route('reviews.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="text-center mb-8">
                        <h3 class="text-2xl font-semibold text-gray-700 mb-6">How would you rate your experience? <span class="text-red-500">*</span></h3>
                        <div class="rating-container p-6 mb-4">
                            <div class="flex justify-center space-x-6 mb-4">
                                <div class="rating-star" data-rating="1">
                                    <div class="star-wrapper">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-gray-300 cursor-pointer transition-all duration-300" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="rating-feedback text-gray-500 text-sm text-center"></div>
                            <div class="selected-rating text-amber-500 font-medium text-lg mt-2 text-center"></div>
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               name="name" 
                               required 
                               class="w-full bg-white px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                    ...
                    <div>
                        ...
                        <textarea id="feedback" 
                                  ...
                                  required 
                                  rows="4" 
                                  class="w-full px-4 py-3 rounded-lg border bg-white border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                    ...
                    <div class="text-center">
                        <button type="submit" 
                                class="bg-[#F05052] hover:bg-[#f05060] hover:cursor-pointer text-white font-semibold px-8 py-3 rounded-lg transition-colors duration-200 transform hover:scale-105">
                            Submit
                        </button>
                    </div>
                </form>
