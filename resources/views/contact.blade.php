    ...
    <div class="container mx-auto px-4">
      <div class="w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <!-- By Air -->
          <div class="perspective h-[300px] md:h-[450px] rounded-lg overflow-hidden">
  ...
  <div class="py-8 sm:py-12 md:py-16">
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
        ...
        <div>
          <div class="p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 transform transition duration-300">
            ...
            <div class="space-y-6">
              <div class="flex items-start group">
                ...
                <div class="ml-4">
                  ...
                  <p class="mt-1 text-gray-600">{{ $settings['phone_number'] ?? '+1 216-288-1303' }}</p>
                  <a href="tel:{{ preg_replace('/[^0-9+]/', '', $settings['phone_number'] ?? '+1 216-288-1303') }}" class="inline-block mt-2 text-blue-600 hover:text-blue-800 font-medium text-sm">Call Us Now →</a>
                </div>
              </div>
              ...
              <div class="flex items-start group">
                ...
                <div class="ml-4">
                  ...
                  <p class="mt-1 text-gray-600">{{ $settings['contact_email'] ?? 'info@whistlerskysports.ca' }}</p>
                  <a href="mailto:{{ $settings['contact_email'] ?? 'info@whistlerskysports.ca' }}" class="inline-block mt-2 text-blue-600 hover:text-blue-800 font-medium text-sm">Email Us →</a>
                </div>
              </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
              ...
              <div class="flex space-x-4">
                <a href="{{ $settings['facebook_url'] ?? '#' }}" target="_blank" class="h-10 w-10 flex items-center justify-center rounded-full bg-blue-600 text-white hover:bg-blue-700 transition duration-300 {{ !isset($settings['facebook_url']) || empty($settings['facebook_url']) ? 'hidden' : '' }}">
                  <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                  </svg>
                </a>
                
                <a href="{{ $settings['twitter_url'] ?? '#' }}" target="_blank" class="h-10 w-10 flex items-center justify-center rounded-full bg-red-600 text-white hover:bg-red-700 transition duration-300 {{ !isset($settings['twitter_url']) || empty($settings['twitter_url']) ? 'hidden' : '' }}">
                  <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="{{ $settings['instagram_url'] ?? '#' }}" target="_blank" class="h-10 w-10 flex items-center justify-center rounded-full bg-red-600 text-white hover:bg-red-700 transition duration-300 {{ !isset($settings['instagram_url']) || empty($settings['instagram_url']) ? 'hidden' : '' }}">
                  <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="{{ $settings['linkedin_url'] ?? '#' }}" target="_blank" class="h-10 w-10 flex items-center justify-center rounded-full bg-blue-800 text-white hover:bg-blue-900 transition duration-300 {{ !isset($settings['linkedin_url']) || empty($settings['linkedin_url']) ? 'hidden' : '' }}">
                  <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fill-rule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clip-rule="evenodd" />
                  </svg>
                </a>

                <a href="{{ $settings['youtube_url'] ?? '#' }}" target="_blank" class="h-10 w-10 flex items-center justify-center rounded-full bg-red-700 text-white hover:bg-red-800 transition duration-300 {{ !isset($settings['youtube_url']) || empty($settings['youtube_url']) ? 'hidden' : '' }}">
                  <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                  </svg>
                </a>

                <a href="{{ $settings['pinterest_url'] ?? '#' }}" target="_blank" class="h-10 w-10 flex items-center justify-center rounded-full bg-red-600 text-white hover:bg-red-700 transition duration-300 {{ !isset($settings['pinterest_url']) || empty($settings['pinterest_url']) ? 'hidden' : '' }}">
                  <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <!-- Contact Form -->
        <div class="h-auto sm:h-[800px] p-4 sm:p-6 md:p-8 transform transition duration-300">
          <h2 class="text-2xl font-bold text-blue-800 mb-6 flex items-center">
            <span class="inline-block mr-3 p-2 bg-blue-100 rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (window.innerWidth <= 640) {
        // Adjust phone input focus behavior
        ...
        // Improve card flip interaction on mobile
