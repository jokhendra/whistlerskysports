                ...
                <div class="mt-5 flex sm:mt-0 sm:ml-4">
                    <span class="relative z-0 inline-flex shadow-sm rounded-md">
                        <form action="{{ route('admin.reviews.update-status', $review) }}" 
                            ...
                            <button type="submit">
                                {{ $review->status === 'pending' ? 'Approve Review' : 'Mark as Pending' }}
                            </button>
                        </form>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6">
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-500">
                    Details and content of the review.
                </p>
            </div>
            <div class="border-t border-gray-200">
                <dl>
                    ...
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            <a href="mailto:{{ $review->email }}" class="text-blue-600 hover:text-blue-900">
                                {{ $review->email }}
                            </a>
                        </dd>
                    </div>
