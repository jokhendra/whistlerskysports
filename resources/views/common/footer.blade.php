    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
      ...
      <div class="space-y-6">
        ...
        <div class="flex space-x-4">
          ...
          <!-- <a href="#" class="w-10 h-10 bg-[#1DA1F2] rounded-lg flex items-center justify-center hover:bg-[#1DA1F2]/90 transition-all duration-300 transform hover:scale-110">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
          </a> -->
          <a href="https://www.instagram.com/whistlerskysports/" target="_blank" class="w-10 h-10 bg-gradient-to-br from-[#FF0069] via-[#E4405F] to-[#C13584] rounded-lg flex items-center justify-center hover:opacity-90 transition-all duration-300 transform hover:scale-110">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://www.linkedin.com/in/whistlerskysports-wss-97243b359/" target="_blank" class="w-10 h-10 bg-[#0077B5] rounded-lg flex items-center justify-center hover:bg-[#0077B5]/90 transition-all duration-300 transform hover:scale-110">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="space-y-4">
          <div class="flex items-start space-x-4 group">
            ...
            <div>
              ...
              <p class="text-blue-100">123 Street Name, City, Country</p>
            </div>
          </div>
          <div class="flex items-start space-x-4 group">
            <div class="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center group-hover:bg-white/20 transition-all duration-300">
            ...
            <div>
              ...
              <p class="text-blue-100">+1 (604) 123-4567</p>
            </div>
          </div>
          <div class="flex items-start space-x-4 group">
            <div class="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center group-hover:bg-white/20 transition-all duration-300">
            ...
            <div>
              ...
              <p class="text-blue-100">info@whistlerskysports.ca</p>
            </div>
          </div>
        </div>
      </div>
